// Basic interface, config menu, and output engine for WRC Suspension Travel & G-Force Calculator
...
namespace WrcTelemetry
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            int turnChoice = int.Parse(Console.ReadLine() ?? "2");
            ...
            int damperChoice = int.Parse(Console.ReadLine() ?? "1");
            ...
            int geometryChoice = int.Parse(Console.ReadLine() ?? "1");
            ...
            WrcCar car = new WrcCar(); // Uses WRC Rally1 default parameters
            ...
            Console.WriteLine($"Load Transfer      : {weightTransferN:F1} N ({weightTransferN / 9.81:F1} kg equivalent)");
